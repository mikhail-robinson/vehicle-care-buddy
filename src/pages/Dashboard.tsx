    ...
    <Layout>
      <div className="space-y-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Vehicle Dashboard</h1>
            <p className="text-gray-500">Monitor and manage your vehicle information</p>
          </div>
        ...
        {!selectedCarId ? (
          <Card className="border-2 border-dashed border-gray-200 p-8">
            <div className="text-center">
              ...
              <h3 className="mt-2 text-lg font-medium text-gray-900">No vehicle selected</h3>
              <p className="mt-1 text-sm text-gray-500">
                Please select a vehicle from the dropdown above to view its details
              </p>
            </div>
          </Card>
        ) : (
